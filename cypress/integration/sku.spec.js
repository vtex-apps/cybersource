describe('Testing Split/Non-Split Sku', () => {
  ...
  it.only('Verifying same sku with split of 10 products(7 and 3) then verify tax amounts via order-tax API', () => {
  ...
  it.only('Verifying same sku with non-split of 10 products then verify tax amounts via order-tax API', () => {
